...
export function themePage (path) {
  return require('theme/pages/' + path + '.vue') // using webpack path alias  - theme/pages = theme/pages
}
...
export function themeComponent (path) {
  return require('theme/components/' + path + '.vue') // using webpack path alias  - core/omponents = core/components
}
