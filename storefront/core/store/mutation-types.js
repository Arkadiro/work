...
export const COMPARE_DEL_ALL = SN_COMPARE + '/DEL_ALL'
...
export const CATEGORY_UPD_CURRENT_CATEGORY_CHILDS = SN_CATEGORY + '/UPD_CURRENT_CATEGORY_CHILDS'
export const CATEGORY_UPD_ROOT_CATEGORY_CHILDS = SN_CATEGORY + '/UPD_ROOT_CATEGORY_CHILDS'
...
export const SN_WATCHEDLIST = 'watched'
export const WATCHED_ADD_ITEM = SN_WATCHEDLIST + '/ADD'
export const WATCHED_LOAD_ITEM = SN_WATCHEDLIST + '/LOAD'

export const SN_CMSPAGE = 'cmspage'
export const CMSPAGE_UPD_CMSPAGES = SN_CMSPAGE + '/UPD_CMSPAGES'

export const SN_CMSBLOCK = 'cmsblock'
export const CMSBLOCK_UPD_CMSBLOCKS = SN_CMSBLOCK + '/UPD_CMSBLOCKS'
